...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-light)] focus:ring-[var(--color-primary-light)]',
    secondary: 'bg-[var(--color-secondary)] text-white hover:bg-[var(--color-secondary-light)] focus:ring-[var(--color-secondary-light)]',
